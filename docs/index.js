...
function simulate()
{
  ...
  simResSASpentMesetaPerPlayer.innerText     = "Spent Meseta Per Player: "+Math.trunc(simSASpent[simWeeks]/saPlayers/10000)/100+"M on average";
  simResF2PSpentMesetaPerPlayer.innerText     = "Spent Meseta Per Player: "+Math.trunc(simF2PSpent[simWeeks]/f2pPlayers/10000)/100+"M on average";
